<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resumendesaldos.aspx.cs" Inherits="BACKEND.reportes.ahorro.resumendesaldos" %>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document" style="margin-right:1%;width:19%;margin-top:0%">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Filtrar a un corte</h5>
