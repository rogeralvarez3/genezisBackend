<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cuentascanceladas.aspx.cs" Inherits="BACKEND.reportes.ahorro.cuentascanceladas" %>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document" style="margin-right:1%;width:19%;margin-top:0%">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <asp:TextBox ID="txtfechas1" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                        <asp:TextBox ID="txtfechas2" runat="server" TextMode="Date" CssClass="form-control"></asp:TextBox>
                    </div>
