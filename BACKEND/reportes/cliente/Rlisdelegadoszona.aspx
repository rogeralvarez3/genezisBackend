<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rlisdelegadoszona.aspx.cs" Inherits="BACKEND.reportes.ahorro.Rlisdelegadoszona" %>
            ...
            <div style="position:absolute;height:7%;width:100%;top:0%;background-color:#0094ff;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color:white;">
               <img src="../../img/LOGO-2.png" style="position:absolute;height:100%;width:5%;"/>
                <div style="position:absolute;height:100%;width:80%;left:20%">
                    <asp:DropDownList ID="txtzona" Height="100%" runat="server" ToolTip="ZONA\BARRIO\COMUNIDAD" AutoPostBack="True" style="position:absolute;height:100%;background-color:#0094ff;border:none;color:white;"></asp:DropDownList>
